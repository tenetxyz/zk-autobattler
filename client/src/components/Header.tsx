...
function Header(props: HeaderProps) {
  ...
  const getPageItems = () => {
    if (location.pathname !== "/") {
      return (
        ...
        <p className="headerItem" onClick={() => navigate("/creations")}>
          Creations
        </p>
  ...
  const getAuthButton = () => {
      if (location.pathname === "/") {
        return (
          <p className="headerItem" onClick={() =>   auth.signIn(()=>{ console.log("here"); navigate("/creations"); }, (err:any) => console.error(`cannot authenticate ${err}`))}>
            Login
          </p>
        );
      }
  ...
  return (
    <div className="headerContainer">
      <div className="leftHeader">
        <div className="appHeader" onClick={() => navigate("/creations")}>
